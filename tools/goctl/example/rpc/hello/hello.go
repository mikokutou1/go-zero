...
import (
	...
	"github.com/mikokutou1/go-zero-m/tools/goctl/example/rpc/hello/internal/config"
	greetServer "github.com/mikokutou1/go-zero-m/tools/goctl/example/rpc/hello/internal/server/greet"
